        ...
        return (React.createElement("div", { className: "react-mde-tabbed-layout" },
            React.createElement(components_1.MdeToolbar, { buttonContentOptions: buttonContentOptions, commands: commands, onCommand: this.handleCommand, readOnly: readOnly },
                React.createElement("div", { className: "mde-tabs" },
                    React.createElement("button", { type: "button", className: styleTabCode, onClick: function () { return _this.setState({ tab: exports.TAB_CODE }); }, tabIndex: -1 }, "Code"),
                    React.createElement("button", { type: "button", className: styleTabPreview, onClick: function () { return _this.setState({ tab: exports.TAB_PREVIEW }); }, tabIndex: -1 }, "Preview"))),
